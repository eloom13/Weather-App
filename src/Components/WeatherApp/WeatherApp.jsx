...
export const WeatherApp = () => {
    ...
    let api_key = "f0a099b32c476b64cef02b35a49c2291";
    ...
    const search = async () => {
        ...
        const humidity = document.getElementsByClassName("humidity-percantage");
    ...
    <div className='container'>
        ...
        <div className="data-container">
            <div className="element">
                ...
                <div className="data">
                    <div className="humidity-percantage">64%</div>
